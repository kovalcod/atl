...
$mail->addAddress('atl-dnr.parts@yandex.ru');
...
$mail->Body    = '' .$name . ' оставил заявку, его телефон ' .$phone. '<br> Почта этого пользователя: ' .$email. ' <br>Тема сообщения ' .$tema . ' <br>Описание проблемы: ' . $message;
$mail->AltBody = '';
